...
describe('CourseListComponent', () => {
    ...
    it('ngOnInit вызывает метод loadCourses', () => {
        const loadCoursesSpy = jest.spyOn(component,'loadAllCourses')
        component.ngOnInit()

        expect(loadCoursesSpy).toHaveBeenCalled()
    })

    it('Устанавливаем в courses то, что получаем из courseService.getAllCourses', () => {
